...
/**
 * this mouse clicked method, shows the occupants 
 * within the school or the city hall 
 * when the school or the city hall is clicked on. 
 * the school has a specific location and when a specific 
 * teacher or police is within the scopes then it would output if there is teachers in the building depending on the school or cityhall 
 * 
 */
