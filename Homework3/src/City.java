...
public void mouseDragged(MouseEvent e) {
	...
	if (drag == 4)
	{
		iPoliceX = e.getX();
		iPoliceY = e.getY();
			if(iPoliceX > 20 && iPoliceX < 400 && iPoliceY > 300 && iPoliceY < 600) {
				cityH.addOccupation(POfficer1);
			}
			else if (iPoliceX > 20 || iPoliceX < 400 || iPoliceY > 300 || iPoliceY < 600) {
	...
	{ 
	 iPolice2X = e.getX();
		iPolice2Y = e.getY();
			if(iPolice2X > 20 && iPolice2X < 400 && iPolice2Y > 300 && iPolice2Y < 600) {
				cityH.addOccupation(POfficer2);
			}
			else if (iPolice2X > 20 || iPolice2X < 400 || iPolice2Y > 300 || iPolice2Y < 600) {
	...
	if (drag == 6)
	{
		iKid1X = e.getX();
		iKid1Y = e.getY();
			if(iKid1X > 20 && iKid1X< 400 && iKid1Y > 300 && iKid1Y < 600) {
				skool.addOccupation(kid1);
			}
			else if (iKid1X > 20 || iKid1X < 400 || iKid1Y > 300 || iKid1Y < 600) {
				skool.removeOccupation(kid1);
			}
	}
	if (drag == 7)
	{
		iKid2X = e.getX();
		iKid2Y = e.getY();
			if(iKid2X > 20 && iKid2X< 400 && iKid2Y > 300 && iKid2Y < 600) {
				skool.addOccupation(kid2);
			}
			else if (iKid2X > 20 || iKid2X < 400 || iKid2Y > 300 || iKid2Y < 600) {
				skool.removeOccupation(kid2);
			}
	}
	repaint();
}
...
public void mouseReleased(MouseEvent e) {
 ...
 if (e.getX()>= iTeacherX && e.getX() <= iTeacherX+60)
{
	System.out.printf(("%s,%d,%d\n"), people[0].getName(), people[0].getAge(),people[0].getPhoneNumber());
}	
	/* else if ((e.getX() > iTeacher2X && e.getX() < iTeacher2X+100))
	 {
		
		 System.out.printf("%s,%d,%d\n",people[1].getName(),people[1].getAge(),people[1].getPhoneNumber());
	 }
	 else if ((e.getX() > iTeacher3X && e.getX() < iTeacher3X+100))
	 { 
		
		 System.out.printf("%s,%d,%d\n",people[2].getName(),people[2].getAge(),people[2].getPhoneNumber());
	 }
	 */
	 else if ((e.getX() > iPoliceX && e.getX() < iPoliceX+100))
	 {	
		 	Police police1 = (Police) people[3];
			System.out.printf("%s,%d,%d,%s\n",people[3].getName(),people[3].getAge(),people[3].getPhoneNumber(), police1.getJobRole());
		 
	 }
	 else if ((e.getX() > iPolice2X && e.getX() < iPolice2X+100))
	 {	
		Police police2 = (Police) people[4];
		System.out.printf("%s,%d,%d,%s\n",people[4].getName(),people[4].getAge(),people[4].getPhoneNumber(), police2.getJobRole());
	 
	 }
	 else if ((e.getX() > iKid1X && e.getX() < iKid1X+100))
	 {	
		System.out.printf("%s,%d,%d\n",people[5].getName(),people[5].getAge(),people[5].getPhoneNumber());
	 }
	// else if ((e.getX() > iKid2X && e.getX() < iKid2X+100)) {	
	//	System.out.printf("%s,%d,%d\n",people[6].getName(),people[6].getAge(),people[6].getPhoneNumber());}
